                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700">
                      <strong>Modo de Demostración:</strong> La imagen de abajo es un ejemplo pre-cargado. Para generar el render 3D hiperrealista exacto de TU plano, el sistema necesita conectarse a una llave de API (OpenAI o Stable Diffusion) en tu servidor.
                    </p>
                  </div>
                </div>
              </div>
